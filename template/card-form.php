            ...
            <div class="back">
                <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg"
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z"/>
                        ...
                        <text transform="matrix(1 0 0 1 621.999 227.2734)" id="svgsecurity" class="st6 st7">985
                        </text>
                        <g class="st8">
                            <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">security code
                            </text>
                        </g>
    ...
    function checkTransaction(invoice) {
        ...
        jQuery.ajax({
            ...
            success: function (response) {
                ...
                // jQuery("#credit_card_form").remove();
                // jQuery(".container-card").remove();
                ...
                var refreshId = setInterval(function (invoice) {
                    ...
                    switch (transaction.status) {
                        case 'fail': {
                            ...
                            jQuery('#message-container').html("<h4 style='color:red;'>" + transaction.message + "</h4>").fadeIn(300);
                            break;
                        }
                        case 'pending': {
